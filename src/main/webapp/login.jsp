...
<html lang="en">
    <head>
        ...
        document.getElementById("div3").innerHTML="*Lastname cant be empty";
                document.getElementById("div3").style.color="Red";
        return false;
        }
        else if(form.phone.value==""){
        document.getElementById("div4").innerHTML="*Mobile cannot be empty";
                document.getElementById("div4").style.color="Red";
        return false;
        }
                ...
                <div class="login_inner">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <form class="login_form row"method="post" onsubmit="return validate(this)">
                                <div class="col-lg-12 form-group">
                                    <input class="form-control" type="email" placeholder="UserName" id="user"name="loginUsername">
                                </div>
                                <div class="col-lg-12 form-group">
                                    <input class="form-control" type="password" placeholder="Password" id="div2"name="loginPassword">
                                </div>
                                <div class="col-lg-12 form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <form class="login_form row" onsubmit="return validate(this)" method="post">
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="text" onkeyup="return checkpattern(this)" placeholder="Full Name" id="full" name="R_name">
                                </div>
                                <div id="div1"></div>
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="text" onkeyup="return checkpattern(this)" placeholder="Email" name="R_email">
                                </div>      
                                <div id="div2"></div>                    
                                <div class="col-lg-6 form-group">
