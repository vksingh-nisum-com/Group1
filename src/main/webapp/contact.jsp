                    ...
                    <div class="carousel_top_h_inner">
                        ...
                        <div class="float-md-right">
                            <div class="top_header_middle">
                                <a href="resources/#"><i class="fa fa-phone"></i> Call Us: <span>+84 987 654 321</span></a>
                                <a href="resources/#"><i class="fa fa-envelope"></i> Email: <span>support@yourdomain.com</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="carousel_menu_inner">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a class="navbar-brand" href="resources/#"><img src="img/logo.png" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav justify-content-end">
                                <li class="search_icon"><a href="resources/#"><i class="icon-magnifier icons"></i></a></li>
                                <li class="user_icon"><a href="resources/#"><i class="icon-user icons"></i></a></li>
                                <li class="cart_cart"><a href="resources/#"><i class="icon-handbag icons"></i></a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <div class="row contact_details">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="resources/tel:+1109171234567">+110 - 917 - 123 - 4567</a>
                                <a href="resources/tel:+1101911897654">+110 - 191 - 189 - 7654</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="resources/mailto:busines@Amazon.com">busines@Amazon.com</a>
                                <a href="resources/mailto:support@Amazon.com">support@Amazon.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-6">
                            <aside class="f_widget f_about_widget">
                                ...
                                <p>Amazon is a Premium Website. Best choice for your online store. Let purchase it to enjoy now</p>
                                <h6>Social:</h6>
                                <ul>
