                ...
                <div class="two_column_product">
                    <div class="row">
                        ...
                        <input type="hidden" name="pid" value="SR2"/>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/product-details/tm1.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="col-sm-6">
                           <form action="viewCtrl">
                        <input type="hidden" name="pid" value="SR3"/>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                ...
                                <div class="l_p_text">
                                   <ul>
                                    ...
                                    <h4>Garmin Vívofit 4 Fitness Tracking Watch, Adult Large (Black)e</h4>
                                    <h5>$95.00</h5>
                                </div>
                            </div>
                            </form>
