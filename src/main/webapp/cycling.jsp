            ...
            <div class="container">
                ...
                <div class="two_column_product">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                        <form action="viewCtrl" >
                        <input type="hidden" name="pid" value="SC2"/>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/product-details/main1.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                <button type="submit" class="add_cart_btn" >VIEW</button>
                                    ...
                                    <h4>Hero RangerDTB-VX 26T 6 Speed Mountain Cycle (Red/Black)   </h4>
                        ...
                        <div class="col-sm-6">
                         <form action="viewCtrl">
                        <input type="hidden" name="pid" value="SC3"/>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/product-details/main2.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                    ...
                                    <h4>Hero Ranger DTB-VX 26T 6 Speed Mountain Cycle (Green/Black)e</h4>
                                    <h5>$95.00</h5>
                                </div>
                            </div>
                            </form>
                        ...
                        <div class="col-sm-6">
                        <form action="viewCtrl" >
                        <input type="hidden" name="pid" value="SC4"/>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/product-details/main3.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                    ...
                                    <h4>Cosmic Voyager 21 Speed Gear Bicycle, 26-inch (Black/Yellow)</h4>
