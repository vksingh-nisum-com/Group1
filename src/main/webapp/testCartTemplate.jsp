        ...
        <section class="solid_banner_area">
            <div class="container">
                <div class="solid_banner_inner">
                    ...
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="resources/shopping-cart2.html">Shopping cart 02</a></li>
                    </ul>
                </div>
            </div>
        </section>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="resources/img/product/cart-product/<%out.print(request.getAttribute("itemImage")); %>" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4><%out.print(request.getAttribute("itemName")); %>"</h4>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><p class="red"><%out.print(request.getAttribute("itemPrice")); %></p></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="resources/img/product/cart-product/cart-4.jpg" alt="">
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <tr class="last">
                                            <th scope="row">
                                                <img src="resources/img/icon/cart-icon.png" alt="">
                                            </th>
                                            <td>
                                                <div class="media">
                                                    <div class="d-flex">
                        ...
                        <div class="cart_totals_area">
                            ...
                            <div class="cart_t_list">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6><%out.print(request.getParameter("subtotal")); %></h6>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="d-flex">
