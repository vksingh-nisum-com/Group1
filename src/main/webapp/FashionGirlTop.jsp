                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/two-column/GT1.jpg" alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/two-column/GT2.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/two-column/GT3.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="resources/img/product/two-column/GT4.jpg" alt="">
                                    <h5 class="sale">Sale</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
